...
export default async function TenantAdminLayout({
  ...
  const nav: NavItem[] = [
    ...
    { href: `${base}/clubs`, label: 'Кружки и услуги', icon: '🎨' },
    { href: `${base}/faq`, label: 'Частые вопросы', icon: '❓' },
    ...
    { href: `${base}/notice`, label: 'Срочное объявление', icon: '📣' },
    { href: `${base}/stats`, label: 'Посещаемость', icon: '📈' },
