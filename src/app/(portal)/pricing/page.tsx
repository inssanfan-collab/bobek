...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      locale === 'kk'
        ? `Жылына ${formatMoney(env.subscriptionPrice)} тұратын балабақша сайты: жүйе, әкімші бөлімі, хостинг, қолдау, портал доменіндегі мекенжай.`
        : `Сайт детского сада за ${formatMoney(env.subscriptionPrice)} в год: движок, админка, хостинг, поддержка, адрес на домене портала.`,
  };
}
...
const FAQ = [
  ...
  },
  {
    ...
    a: {
      kk: 'Иә. edu.kz аймағындағы доменді өзіңіз сатып аласыз және өзіңізге рәсімдейсіз, ал біз баптауға көмектесеміз. Бұрынғы мекенжай жұмыс істей береді.',
      ru: 'Да. Домен на EDU.KZ покупаете сами и оформляете на организацию, а мы поможем настроить. Прежний адрес продолжит работать.',
    },
  },
  {
