...
const T = {
  ...
  viewPlans: { kk: 'Тарифтер', ru: 'Тарифы' },
  mockPhotoAlt: {
  ...
  gardensSection: { kk: 'Бізбен бірге', ru: 'Уже с нами' },
...
/**
 * Страница для детских садов: чем сайт полезен саду, сколько стоит и как
 * подключиться. Раньше всё это было на главной, но главная — для родителей:
 * их на портале в сотни раз больше, чем заведующих. Сюда ведут кнопки
 * «Подключить сад» из шапки, с главной и из каталога.
 */
