...
const T = {
  ...
  priceBoth: {
    kk: 'Екеуінде де: сайт, әкімші бөлімі, Қазақстандағы хостинг, сақтық көшірмелер, қолдау. edu.kz домені бөлек — баптауға тегін көмектесеміз.',
    ru: 'В обоих: сайт, админка, хостинг в Казахстане, резервные копии, поддержка. Домен edu.kz — отдельно, настроить поможем бесплатно.',
  },
...
export default async function ConnectPage({
  ...
  const HOWTO = [
    ...
    {
      title: { kk: 'edu.kz доменін қалай жалғау керек', ru: 'Как подключить свой домен edu.kz' },
      steps: [
        {
          kk: 'Доменді .kz тіркеушісінен ұйымның атына сатып алыңыз: edu.kz аймағы білім беру ұйымдарына арналған.',
          ru: 'Купите домен у регистратора .kz на свою организацию: зона edu.kz — для организаций образования.',
        },
        serverIp
          ? {
              kk: `Домен баптауларында A-жазба жасаңыз: ${serverIp}.`,
              ru: `В настройках домена создайте A-запись на адрес ${serverIp}.`,
            }
          : {
