...
const PATHS = {
  ...
  folder: (
    <>
      <path d="M3.5 7.5a2 2 0 0 1 2-2h3.3l2 2.2h7.7a2 2 0 0 1 2 2v7.8a2 2 0 0 1-2 2h-13a2 2 0 0 1-2-2z" />
      <path d="M3.5 10.5h17" />
    </>
  ),
  file: (
    <>
      <path d="M6.5 3.5h7l4.5 4.5v12a1 1 0 0 1-1 1h-10.5a1 1 0 0 1-1-1v-15a1 1 0 0 1 1-1" />
